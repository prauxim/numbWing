...
<<<<<<< HEAD
    ...
    # run_benchmark(n_battles=50, brief_cnt=1, use_prev_results=True, mode='squad')
...
def example_battle():
    ...
    battle.fight(50, brief_cnt=3, print_match_summary=True)
...
<<<<<<< HEAD
    :param ships: array if ship indtification enums, or 'all' to run all
    ...
    :param log_cnt: number of battle to print detailed battle logs,  for each ship
    :param brief_cnt: number of battle to print brief battle logs,  for each ship
=======
...
>>>>>>> de3179ab2b88d910a55309faba731782fffc7a02
            ...
            for bm_health_base in range(hp_init, 99):
                ...
                battle = Match(team_1, team_2)
<<<<<<< HEAD
                battle.fight(n_matches, log_cnt=log_cnt, brief_logs=brief_logs)
=======
...
>>>>>>> de3179ab2b88d910a55309faba731782fffc7a02
        ...
        if match_summary:
<<<<<<< HEAD
            battle_summary_path = '../results/benchmark_1v1_summary.txt'
=======
